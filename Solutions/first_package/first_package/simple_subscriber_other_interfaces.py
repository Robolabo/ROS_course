...
class MinimalSubscriber(Node):
    def __init__(self):
        ...
        super().__init__('node_subscriber_other_interfaces')  # <-- Replace 'NICKNAME' with your actual group number
        ...
        self.subscription = self.create_subscription(
            ...
            'topic_other_interfaces_sub',  # <-- Replace 'NICKNAME' with the specific topic name for your group
