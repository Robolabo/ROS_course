...
class MinimalPublisher(Node):
    def __init__(self):
        ...
        super().__init__('node_publisher_other_interfaces')  # <-- Replace 'NICKNAME' with your actual group number
        
        # Step 2: Create a publisher for your topic
        # Replace 'topic_ID' with a unique topic name (e.g., 'topic_1' for Group 1)
        self.publisher_ = self.create_publisher(BatteryState, 'topic_other_interfaces_pub', 10)  # <-- Replace 'NICKNAME'
        ...
        timer_period = 0.01  # <-- You can change this to another value like 1.5 or 3.0
